...
from train import *
from test import *
from model.MFFD import MultimodalFusionForgeryDetector
...
model_path = './checkpoint/MFFD_resnet18_classifier.pth'
def train_MFFD():
    # 初始化模型
    model = MultimodalFusionForgeryDetector(weights=ResNet18_Weights.DEFAULT)
...
def load_MFFD():
    # 加载保存的模型
    model = MultimodalFusionForgeryDetector(weights=None)
